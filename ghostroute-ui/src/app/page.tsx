  ...
  return (
    <main className="min-h-screen w-full bg-ghost-dark text-foreground grid-pattern relative overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="text-center my-16 animate-slide-up">
        ...
        <div className="max-w-6xl mx-auto mt-8 mb-12">
          <div className="glass rounded-2xl p-8 border-2 border-ghost-border/50 shadow-card animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="flex flex-col items-center text-center gap-2">
                <div className="flex items-center justify-center w-16 h-16 rounded-full bg-ghost-card border border-ghost-border/50 mb-4 glow">
                  <span className="font-display text-2xl text-ghost-cyan">1</span>
                </div>
              ...
              <div className="flex flex-col items-center text-center gap-2">
                <div className="flex items-center justify-center w-16 h-16 rounded-full bg-ghost-card border border-ghost-border/50 mb-4 glow">
                  <span className="font-display text-2xl text-ghost-cyan">2</span>
                </div>
        ...
        {/* Features Section */}
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 my-16">
          <div className="glass rounded-2xl p-8 border-2 border-ghost-border/50 shadow-card">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>Zero-Knowledge proofs for ultimate privacy</span></li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>UTXO-based privacy model with commitments</span></li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>Poseidon hash for efficient ZK circuits</span></li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>All cryptography is handled client-side</span></li>
            </ul>
          </div>
          <div className="glass rounded-2xl p-8 border-2 border-ghost-border/50 shadow-card">
            <h3 className="text-2xl font-display font-bold mb-4 text-gradient">Robust & Resilient</h3>
            <ul className="space-y-3">
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>Support for Sepolia Testnet & Ethereum Mainnet</span></li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>Multi-transport RPC for reliable connections</span></li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>Automatic failover for uninterrupted service</span></li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-ghost-cyan" /><span>Designed for security and decentralization</span></li>
            </ul>
          </div>
        </div>
      </div>
